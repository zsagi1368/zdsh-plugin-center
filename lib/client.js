...
function extractSha8(phrase) {
	return phrase.match(/@([0-9a-f]{8})\b/)?.[1] ?? "";
}
...
function PluginCenterApp(props) {
	...
	const stageInstall = async (entryId) => {
		setError("");
		try {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)(EntryList, {
				data,
				locale,
				onInstall: (id) => void stageInstall(id)
			}),
			/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		...
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
					className: "zdsh-pc-note",
					children: `install · ${props.dialog.entryId}`
				}),
				/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
					className: "zdsh-pc-code",
					children: props.dialog.phraseSha8
				}),
